(function( $ ){
	...
	$.fn.servercircle = function( options ) {  
		...
		var totalLine = 360*((((100-settings['outerPercent'])/100)*100)/topValue);
		...
		{
			var fontSize = ((18/100)*(radius+lineWidth))*2;
			...
			var fontSize = ((16/150)*(radius+lineWidth))*2;
