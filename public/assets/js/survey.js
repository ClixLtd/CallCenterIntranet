$(function () {
  ...
  var portalAddress = "http://callcenterintranet.clix.dev/survey/api/";
	...
	$("#checkForm").submit(function(){
		...
		$.ajax({url: portalAddress + "validate/"+apiKey+".jsonp", contentType: 'application/json', dataType: "JSONP", data: ($("#checkForm").serialize()+"&"+$('#vicidial_form', window.parent.document).serialize()), cache: false, success: function(data) {
