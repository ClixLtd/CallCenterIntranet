...
ORDER BY
	...
	, ps.DateExpected
	, CONVERT(Money,(ps.Amount+ps.OvertimeAmount+ps.AdditionalAmount)) as AmountExpected
	, CONVERT(money,ISNULL(PR.Amount,0)) as 'Amount Received'
...
WHERE
	...
	public function action_monthly_payment()
	{
	    ...
	    $reportArray = Controller_Reports::generate_monthly_payment_report(null, "2012-11-01", "2012-12-01");
