	...
	public static function generate_telesales_report($center=null)
	{
    	...
    	foreach ($staff AS $member)
    	{
    	    ...
    	    $sendArray[] = array(
    	       ...
    	       'points'         => number_format((($reportArray[$member->dialler_id]['referrals'] * $centerValue['referral']) + ($reportArray[$member->dialler_id]['packOuts'] * $centerValue['pack_out']) + ($reportArray[$member->dialler_id]['totalDI'] * $centerValue['di_point'])),2),
