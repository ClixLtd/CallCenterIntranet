<article class="full-block clearfix">
	...
	<section>
				...
				<script>
					$(function () {
						...
						function fillChart()
						{
				            ...
				            $.ajax({
				                url: "/dialler/campaign/liveview/GAB-1"+timeLink+".json",
				                method: 'GET'
				            }).done(function(data) {
				            	var inputData = [ ];
				...
				<script>
					$(function () {
						...
						function fillChart()
						{
				            ...
				            $.ajax({
				                url: "/dialler/campaign/liveview/GBS-1"+timeLink+".json",
				                method: 'GET'
				            }).done(function(data) {
				            	var inputData = [ ];
		...
		<article class="half-block clearrm">
			...
			<section>
				<div id="sms1LiveChart" class="flotChart" style="width: 100%; height: 300px;"></div>
				<script>
					$(function () {
						...
						function fillChart()
						{
				            ...
				            $.ajax({
				                url: "/dialler/campaign/liveview/SMS-1"+timeLink+".json",
				                method: 'GET'
				            }).done(function(data) {
				            	var inputData = [ ];
					            ...
					            $.plot($("#sms1LiveChart"), inputData, options);
